...
| Compose a persona from presets instead of hand-writing an archetype | [trait_dimensions.py](/concepts/subsystems/candidate-agent.md) — `compose_archetype`/`register_dynamic` for the skill/verdict axis, `compose_human_traits` for the §3.2 realism/compliance taxonomy |
